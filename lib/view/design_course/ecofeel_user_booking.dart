...
class EcoFeelUserDetails extends StatefulWidget {
  var model;
  EcoFeelUserDetails({this.model});

  @override
  _EcoFeelUserDetailsState createState() => _EcoFeelUserDetailsState();
}

class _EcoFeelUserDetailsState extends State<EcoFeelUserDetails>
  ...
  cancel(String val) async {
    ...
    Map response = await apiBaseHelper.postAPICall(
        Uri.parse(
            "https://alphawizztest.tk/Deffo/api/Authentication/"),
        param);
    setState(() {
      status = false;
    });
                  ...
                  child: Container(
                    decoration: BoxDecoration(
                        image: DecorationImage(
                            fit: BoxFit.cover,
                            image: NetworkImage("$imagePath${model.image}"))),
                  ),
                ),
              ],
            ),
